...
{0x28, 0x2F, 0x9E, 0xAF, 0x7, 0x0, 0x0, 0xD0};//Waterproof temp sensor address
/***********REPLACE THIS ADDRESS WITH YOUR ADDRESS*************/
...
void printInfo()
{
  //This function prints the weather data out to the default Serial Port
      ...
      Serial.println(soilMoisture0);//Mositure Content is expressed as an analog
...
int postToPhant()
{
    ...
    phant.add("hg", (pascals/100.0) * 0.02952998751);
    ...
    phant.add("windspeed_avg", windspdmph_avg2m);
    phant.add("windgust_avg", windgustmph_10m);
